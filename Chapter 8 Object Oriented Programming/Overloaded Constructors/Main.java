public class Main {
 class Main_constructor {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Shop type: " + newShop.shopType);
        System.out.println("Dish: " + newShop.dish);
        System.out.println("Drink: " + newShop.drink);
        System.out.println("Price: " + newShop.price);
